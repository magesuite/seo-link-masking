...
$eavSetup->addAttribute(
    ...
    'select_attribute_with_xss_payload_duplicate_options',
    [
        'group' => 'General',
        'type' => 'int',
        'label' => 'select_attribute_with_xss_payload_duplicate_options',
        'input' => 'select',
        ...
        'option' => [
            'values' => [
                ...
                '<img src=x onerror=alert(document.domain)>',
                'unique_option_in_select_attribute_with_xss_payload_duplicate_options'
            ]
        ]
    ]
);
